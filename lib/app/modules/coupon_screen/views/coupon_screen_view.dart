                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            controller.isEditing.value =
                                                                                true;
                                                                            controller.couponTitleController.value.text =
                                                                                couponModel.title!;
                                                                            controller.couponCodeController.value.text =
                                                                                couponModel.code!;
                                                                            controller.couponMinAmountController.value.text =
                                                                                couponModel.minAmount!;
                                                                            controller.couponAmountController.value.text =
                                                                                couponModel.amount!;
                                                                            controller.isActive.value =
                                                                                couponModel.active!;
                                                                            controller.editingId.value =
                                                                                couponModel.id!;
                                                                            controller.selectedAdminCommissionType.value = couponModel.isFix == true
                                                                                ? 'Fix'
                                                                                : 'Percentage';
                                                                            controller.couponPrivateTyep.value = couponModel.isPrivate == true
                                                                                ? 'Private'
                                                                                : 'Public';
                    ...
                    children: [
                      Expanded(
                          child: CustomTextFormField(
                              ...
                              controller:
                                  controller.couponMinAmountController.value,
                      ...
                      Expanded(
                          child: CustomTextFormField(
                              ...
                              controller:
                                  controller.couponAmountController.value,
                              title: 'Amount'.tr)),
                    ],
                  ),
                  Row(
                            ...
                            Obx(
                              () => DropdownButtonFormField(
                                ...
                                onChanged: (String? taxType) {
                                  controller.selectedAdminCommissionType.value =
                                      taxType ?? "Fix";
                                },
                                value: controller
                          ...
                          children: [
                            ...
                            Obx(
                              () => DropdownButtonFormField(
                                ...
                                hint:
                                    TextCustom(title: 'Select Coupon Type'.tr),
                                onChanged: (String? couponType) {
                                  controller.couponPrivateTyep.value =
                                      couponType ?? "Public".tr;
                                },
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextFormField(
                                ...
                                controller:
                                    controller.expireDateController.value,
              ...
              CustomButtonWidget(
                ...
                onPress: () {
                  if (Constant.isDemo) {
                    ...
                    if (controller
                            .couponTitleController.value.text.isNotEmpty &&
                        controller.couponCodeController.value.text.isNotEmpty &&
                        controller
                            .couponMinAmountController.value.text.isNotEmpty &&
                        controller
                            .couponAmountController.value.text.isNotEmpty &&
