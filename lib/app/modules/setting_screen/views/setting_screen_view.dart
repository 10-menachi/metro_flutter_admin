          ...
          return ResponsiveWidget(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GetBuilder(
                            ...
                            builder: (controller) {
                              return controller
                                      .selectSettingWidget.value.widget![
                                  controller
                                      .selectSettingWidget.value.selectIndex!];
                            }),
                      )
                    ]),
              ),
                        ...
                        Row(
                            ...
                            children: [
                              Expanded(
                                  ...
                                  child: ContainerCustom(
                                    ...
                                    child: ListView.separated(
                                        shrinkWrap: true,
                                        itemCount:
                                            controller.settingsAllPage.length,
                                        ...
                                        itemBuilder: (itemBuilder, index) {
                                          return InkWell(
                                            onTap: () {
                                              controller.settingsAllPage[index]
                                                  .selectIndex = 0;
                                              controller.selectSettingWidget
                                                      .value =
                                                  controller
                                                      .settingsAllPage[index];
                                              controller.update();
                                            },
                                            child: ContainerCustom(
                                              radius: 2,
                              ...
                              Expanded(
                                  ...
                                  child: controller
                                          .selectSettingWidget.value.widget![
                                      controller.selectSettingWidget.value
                                          .selectIndex!]),
                            ])
                      ],
                    )),
            ...
            desktop: Scaffold(
              ...
              appBar: CommonUI.appBarCustom(
                  ...
                  scaffoldKey: controller.scaffoldKeysDrawer),
              body: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  if (ResponsiveWidget.isDesktop(context)) ...{
                            ...
                            Expanded(
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    spaceW(width: 20),
                                    Expanded(
                                        child: controller.selectSettingWidget
                                                .value.widget![
                                            controller.selectSettingWidget.value
                                                .selectIndex!]),
                                  ]),
