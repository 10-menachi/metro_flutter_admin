...
class PassengersDetailScreenView
    extends GetView<PassengersDetailScreenController> {
  const PassengersDetailScreenView({super.key});
  @override
                                                                ...
                                                                FittedBox(
                                                                  child: Text(
                                                                    ...
                                                                    style: Constant
                                                                      ...
                                                                      color: themeChange
                                                                              .isDarkTheme()
                                                                          ? AppThemData.primaryWhite.withOpacity(
                                                                              .7)
                                                                          : AppThemData
                                                                              .primaryBlack
                                                                              .withOpacity(.7),
          ...
          widgetList: [
            SizedBox(
              child: CustomTextFormField(
                  ...
                  controller: controller.topupController.value),
            ),
          ],
          bottomWidgetList: [
            Row(
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        WalletTransactionModel walletTransactionModel =
                            controller.currentPageWalletTransaction[index];
                        return Container(
                          width: 358,
                          height: 80,
                                ...
                                child: Center(
                                  child: SvgPicture.asset(
                                    ...
                                    colorFilter: ColorFilter.mode(
                                        (walletTransactionModel.isCredit ??
                                                false)
                  ...
                  Align(
                    ...
                    child: WebPagination(
                        ...
                        onPageChanged: (page) {
                          ...
                          controller.setPaginationForTransactionHistory(
                              controller.totalItemPerPage.value);
                        }),
                  ),
                ],
              ),
